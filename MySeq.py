class MySeq:
    ...
    def __getitem__(self, n):
        return self.seq[n] #vai buscar o aminoácido presente na posição n da seq

    def __getslice__(self, i, j):
        return self.seq[i:j] #vai buscar a posição

    def __str__(self):
        return self.tipo + ":" + self.seq # dá print do tipo de seq e da seq

    def printseq(self):
        print(self.seq) #dá print da seq
    ...
    def maiorProteina (self): #vai procurar a maior proteinas possível numa tradução de DNA
    ...
    def todasProteinas(self): #vai that output de uma lista com todas as proteínas possíveis numa seq proteica.
        if (self.tipo != "protein"):
            return None
        seqAA = self.seq
        protsAtuais = [] #proteina atual
        proteinas = [] #proteian final
        for aa in seqAA:
            if aa == "_":
                if protsAtuais:
    ...
    def maiorProteinaORFs (self): #vai ver qual é a maior prteina codificada por uma seq de DNA
        if (self.tipo != "dna"):
            return None
        larg = MySeq("","protein")
